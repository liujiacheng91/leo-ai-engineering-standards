...
|---|---|---|---|---|---:|---:|---:|---:|---:|---|---:|---|---|
| ic-trans-final-shipment-number | bus-freightlist-handler-service | FREIGHTLIST | Yellow | Opus | ~65K (estimated) | ~15K (estimated) | ~80K (estimated) | ~$0.80 (estimated) | 0 | No | 0.5 | Merged | Yes |
...
| Code Implementation | Opus | ~15K (estimated) | ~$0.15 | 19% | 1 文件: Node3IcTransFinalCalc.java (+2 行) |
...
| Token / Saved Hours | ~160K/hr (estimated) |

> 参考基准: EDI $0.07/hr, VBO $0.18/hr, BizDB $0.59/hr。本案高于 BizDB 基准，因 Yellow 风险 + Opus 模型 + 完整文档产出（含上下文恢复开销）。
