...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| full-auto-workflow | bus-freightlist-handler-service | FREIGHTLIST | Green | Opus | ~60K (estimated) | ~8K (estimated) | ~68K (estimated) | ~$1.36 (estimated) | 0 | No | 0.3h | Done | No |
...
| Code Implementation | Opus | ~15K (estimated) | ~$0.30 | 22% | fullAutoWorkflow 方法体 ~20行 |
